...
### Registry and service stewards
You operate a Commitment Pool registry, routing service, clearing service, or shared safety layer. You publish the rules, fees, and risk limits for your network profile, then tune them based on real settlement KPIs, not price volatility.
...
If you want these numbers to reflect a specific scenario for your network, run the [simulator](https://sim.cosmolocal.credit/).
